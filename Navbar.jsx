...
function Navbar() {
  ...
  return (
    <div
      className={`fixed z-[999] w-full px-20 py-6 font-["Neue Montreal"] flex justify-between items-center transition-transform duration-500 ${
        showNavbar ? 'translate-y-0' : '-translate-y-full'
      } backdrop-blur-sm bg-white/3`}
    >
      <div className='logo'>
